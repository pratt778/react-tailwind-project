const News = () => {
    return <>
        <div className="news-container max-w-[1200px] bg-black w-full mx-auto p-2">
            <div className="newsletter flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-center sm:gap-8">
                ...
                <div className="searchbox flex flex-col gap-1 w-full sm:w-fit ">
