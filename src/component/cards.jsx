...
return <>
    <div className="card-container h-[fit] bg-white w-full text-black pt-4 pb-3">
        <div className="main-card flex flex-col justify-center items-center gap-2 p-2 sm:grid sm:grid-cols-2">
            <div className="cards flex flex-col w-[300px] items-center justify-center gap-4 rounded-lg py-4 shadow-xl">
